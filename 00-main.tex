...
\def\PrintingOffset{0.0in}                  % additional left margin for the printed copy
...
\usepackage[backend=biber,
            ...
            mincitenames=1,    % show at least 1 name before "et al."
            uniquelist=false,  % don't expand ambiguous citations
            maxbibnames=99,
            date=year,
            isbn=false,
            url=false,
            doi=true,
            giveninits=false,  % Don't use initials
            uniquename=false,  % Don't differentiate between same last names
           ]{biblatex}
...
\include{05a-introduction}
\part{Analyzing Implicit Structured Representations}
\include{06-chapter-1}
\part{Structural Operations on Explicit Tree Representations for Out-of-Distribution Generalization}
\include{07-chapter-2}
\include{08-chapter-3}
\part{Improving Transformers on Formal Languages}
\include{09-chapter-4}
\include{10-chapter-5}

\part{Conclusion}
\include{10a-chapter-6}

\part{Bibliographic references}
